...
export default function PrivacyPolicy() {
  return (
    <div className="w-full relative py-20 px-4 md:px-8 max-w-4xl mx-auto space-y-16 text-left">
      ...
      {/* 1. PAGE HEADER */}
      <div className="space-y-6 border-b border-stone-200 pb-10 relative z-10">
      ...
      {/* 2. SUMMARY CARD */}
      <Card variant="slate" padding="md" className="border-stone-250 bg-stone-50 flex gap-4 items-start relative z-10 shadow-premium p-6 max-w-[720px] rounded-2xl">
        <Shield className="h-6 w-6 text-emerald-600 shrink-0 mt-1" />
        <div className="space-y-2 text-xs text-stone-600 leading-relaxed font-medium">
          <h3 className="font-bold text-sm text-stone-900">Your Privacy is Protected Under HIPAA Standards</h3>
          <p>
      ...
      {/* 3. POLICY DETAILS */}
      <div className="space-y-12 text-sm text-stone-700 leading-relaxed relative z-10 max-w-[720px]">
        
        {/* Section 1 */}
        <div className="space-y-4">
          <h3 className="text-xl md:text-[28px] font-bold text-stone-900 font-heading border-b border-stone-200 pb-2">1. Collection of Health and Personal Information</h3>
          <p className="text-[18px] text-stone-605 font-medium leading-[1.75]">
          ...
          <ul className="list-disc pl-6 space-y-2.5 text-[18px] text-stone-600 font-medium">
        ...
        {/* Section 2 */}
        <div className="space-y-4">
          <h3 className="text-xl md:text-[28px] font-bold text-stone-900 font-heading border-b border-stone-200 pb-2">2. How We Use Your Protected Health Information</h3>
          <p className="text-[18px] text-stone-605 font-medium leading-[1.75]">
        ...
        {/* Section 3 */}
        <div className="space-y-4">
          <h3 className="text-xl md:text-[28px] font-bold text-stone-900 font-heading border-b border-stone-200 pb-2">3. Your Health Information Rights</h3>
          <p className="text-[18px] text-stone-605 font-medium leading-[1.75]">
        ...
        {/* Section 4 */}
        <div className="space-y-4">
          <h3 className="text-xl md:text-[28px] font-bold text-stone-900 font-heading border-b border-stone-200 pb-2">4. Contact Our HIPAA Officer</h3>
          <p className="text-[18px] text-stone-605 font-medium leading-[1.75]">
          ...
          <div className="bg-stone-50 p-6 rounded-xl border border-stone-200 text-xs space-y-2 shadow-inner text-stone-600 font-medium">
            <p className="text-sm font-bold text-stone-900">Amara Pain &amp; Spine Management</p>
