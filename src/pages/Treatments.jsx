    ...
    <div ref={containerRef} className="w-full relative py-16 px-4 md:px-8 max-w-7xl mx-auto space-y-16 text-left">
      ...
      <div className="relative z-10">
        {filteredTreatments.length > 0 ? (
              ...
              >
                <div className="space-y-5">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <Badge variant="accent" className="bg-emerald-50 text-emerald-850 border border-emerald-250 font-bold tracking-wide text-[10px]">Minimally Invasive</Badge>
                  </div>

                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-bold font-heading text-stone-900 group-hover:text-emerald-705 transition-colors">
                      {treat.title}
                    </h3>
                    <span className="text-xs text-stone-500 font-bold uppercase tracking-wider flex items-center gap-1">
                      <Clock className="h-3.5 w-3.5 text-emerald-600" /> Outpatient Recovery: 1-3 Days
                    </span>
                  </div>
          ...
          <div className="text-center py-16 bg-white rounded-2xl border border-stone-205 space-y-4 shadow-sm">
            <p className="text-stone-500 text-base">No treatments found matching your search term.</p>
      ...
      <Card variant="slate" padding="lg" className="border-stone-200 bg-stone-50 flex flex-col md:flex-row gap-6 items-center justify-between relative z-10 shadow-premium p-8 animate-reveal rounded-2xl">
        ...
        <Link to="/contact" className="shrink-0 w-full md:w-auto">
          <Button variant="outline" className="w-full md:w-auto text-stone-900 border-stone-300 hover:bg-stone-50">
