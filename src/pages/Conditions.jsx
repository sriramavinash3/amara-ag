...
export default function Conditions() {
  ...
  return (
    <div ref={containerRef} className="w-full relative py-20 px-4 md:px-8 max-w-7xl mx-auto space-y-16 text-left overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-bg-slate via-transparent to-bg-slate z-10" />
        <img src="/images/conditions_bg.png" alt="Healing Background" className="w-full h-full object-cover object-top mix-blend-multiply opacity-50" />
      </motion.div>
